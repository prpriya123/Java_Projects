  ...
  <body ng-app="myApp" class="ng-cloak">
      <div class="generic-container" ng-controller="UserController as ctrl">
          ...
          <div class="panel panel-default">
              ...
              <span class="lead"><button type="button" ng-click="ctrl.submitUsersErr()" class="btn btn-success custom-width">A-Submit</button> </span>
              <span class="lead"><button type="button" ng-click="ctrl.submitUsers()" class="btn btn-success custom-width">B-Submit</button> </span>
              </div>
